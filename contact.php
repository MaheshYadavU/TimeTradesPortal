...
<head>
	...
	<title>TimeTrades - Contact Us</title>
    ...
    <meta property="og:image:alt" content="TimeTrades" />
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">Available Jobs</a>
					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" name="message" class="form-control" rows="8"  ></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>Via Ariosto, 25, 00185 Roma RM </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:headhr.timetrades@gmail.com">headhr.timetrades@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="+39347719184">+39347719184</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About TimeTrades</h5>
											<p>TimeTrades is a Job portal, online job management system developed by Mahesh and Asfand in April 2022.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Available Jobs</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">TimeTrades Contact</h5>
								
								<p>Address : Via Ariosto, 25, 00185 Roma RM.</p>
								<p>Email : <a href="info@timetrades.com">info@timetrades.com</a></p>
								<p>Phone : <a href="tel:+393477219184">+393477219184</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?>TimeTrades</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Mahesh and Asfand</a></li>
								</ul>
