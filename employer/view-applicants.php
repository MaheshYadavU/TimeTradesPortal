...
<head>
	...
	<title>TimeTrades - Applicants for the job <?php echo "$job_title"; ?></title>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About TimeTrades</h5>
											<p>TimeTrades is a job portal, online job management system developed by Nathaniel Nkrumah for his project in february 2018.</p>
